...
combined_cal <- rbind(
  ...
  data.frame(model = "Sorour", grninf = puf_pad_grninf_preop$grninf, .pred_TRUE = puf_pad_grninf_preop$s_nomo),
...
combined_cal <- rbind(
  ...
  data.frame(model = "Sorour", grninf = puf_pad_grninf_preop$s_grninf, .pred_TRUE = puf_pad_grninf_preop$s_nomo),
